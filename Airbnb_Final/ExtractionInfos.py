...
def extract_info(url):
    ...
    try:
        ...
        hote_info = extract_text('div', {"class": "t1pxe1a4 atm_c8_2x1prs atm_g3_1jbyh58 atm_fr_11a07z3 atm_cs_10d11i2 dir dir-ltr"})
        ...
        if int(nb_comment)<3:
            evaluation = "Nouveau"
        return {"Nom de l'annonce": nom_annonce, "Type": type, "Informations supplémentaires": info_supp, "Hôte": hote_info, "Ville": ville, "Nombre de commentaires": nb_comment, "Evaluation": evaluation, "Prix": prix,"Commentaires": commentaires,  "URL": url}
...
df.to_excel('/Users/othmaneirhboula/WebScrap/Airbnb_Final/ScrapingAirbnb.xlsx', index=False)
# print(extract_info("https://fr.airbnb.com/rooms/738098352181404269?adults=1&category_tag=Tag%3A8678&children=0&enable_m3_private_room=true&infants=0&pets=0&photo_id=1508770426&search_mode=regular_search&check_in=2025-01-05&check_out=2025-01-10&source_impression_id=p3_1721207298_P3R9RoBCJeoSq7Wh&previous_page_section_name=1000&federated_search_id=a46cd8c4-efc3-4860-87d3-f2522825b0ab&_set_bev_on_new_domain=1721132874_EANjNmZmExZDM1OG"))
